...
def generate_index():
    ...
    for p in key_projects[:3]:
        ...
        project_cards += f'''
                <div class="card" onclick="window.location='/github-researcher/{href}'" style="cursor:pointer">
                    <div class="card-top">
...
def generate_projects_list():
    ...
    for p in all_projects:
        ...
        cards += f'''                <div class="card" onclick="window.location='/github-researcher/{href}'" style="cursor:pointer">
                    <div class="card-top">
                        <div class="card-emoji">{emoji}</div>
                        <div class="card-stars">{stars}</div>
                    </div>
...
'''
        ...
        if key_projects:
            ...
            for p in key_projects:
                ...
                date_sections += f'''
                <div class="card" onclick="window.location='/github-researcher/projects/{slug}.html'" style="cursor:pointer">
                    <div class="card-top">
